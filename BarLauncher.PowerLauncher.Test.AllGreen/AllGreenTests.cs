...
namespace BarLauncher.PowerLauncher.Test.AllGreen
{
    public class AllGreenTests
    {
        private static readonly ITestRunnerService _testRunnerService = new TestRunnerService();

        private static readonly TestFinder<PowerLauncherContext> _testFinder = new TestFinder<PowerLauncherContext>()
        {
